<?php
    ...
    $currentTopic = isset($_SESSION['current_topic']) ? $_SESSION['current_topic'] : 'sports';
    ...
    $playerAnswers = isset($_SESSION['player_answers']) ? $_SESSION['player_answers'] : [];
    ...
    foreach ($selectedQuestions as $index => $questionData) {
        ...
        $userAnswer = isset($playerAnswers[$index]) ? $playerAnswers[$index] : '';
    ...
    if ($_SESSION['score_updated'] === false) {
        // Update the total score/ game & overall score for all games
